...
complete -c bootware -n '__fish_seen_subcommand_from bootstrap' -x -s i -l inventory -d 'Ansible host IP addesses'
...
complete -c bootware -n '__fish_seen_subcommand_from bootstrap' -x -l password -d 'Remote host user password'
...
complete -c bootware -n '__fish_seen_subcommand_from bootstrap' -x -l user -d 'Remote host user login name'
