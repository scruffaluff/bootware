...
COPY --chown=alpine:alpine bootware.sh /bootware/
COPY --chown=alpine:alpine completions/ /bootware/completions/
COPY --chown=alpine:alpine scripts/ /bootware/scripts/
