...
gsettings --schemadir "${HOME}/.local/share/gnome-shell/extensions/forge@jmmaranan.com/schemas" get org.gnome.shell.extensions.forge move-pointer-focus-enabled true
