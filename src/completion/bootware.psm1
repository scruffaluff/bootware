    ...
    $Completions = @(
        switch ($Command) {
            'bootware' {
                ...
                [CompletionResult]::new('bootstrap', 'bootstrap', [CompletionResultType]::ParameterValue, 'Bootstrap install computer software')
            ...
            'bootware;bootstrap' {
                ...
                [CompletionResult]::new('--inventory', '--inventory', [CompletionResultType]::ParameterName, 'Ansible remote hosts IP addresses')
