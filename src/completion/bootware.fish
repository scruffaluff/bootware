...
complete -c bootware -n '__fish_seen_subcommand_from bootstrap' -x -l install-group -d 'Remote group to install software for' -a '$(__fish_complete_groups)'
complete -c bootware -n '__fish_seen_subcommand_from bootstrap' -x -l install-user -d 'Remote user to install software for' -a '$(__fish_complete_users)'
complete -c bootware -n '__fish_seen_subcommand_from bootstrap' -x -s i -l inventory -d 'Ansible remote hosts IP addesses' -a '$(__fish_print_hostnames)'
...
complete -c bootware -n '__fish_seen_subcommand_from bootstrap' -x -s s -l skip -d 'Ansible playbook tags to skip' -a 'desktop server sysadmin wsl $(bootware roles)'
complete -c bootware -n '__fish_seen_subcommand_from bootstrap' -x -l start-at-role -d 'Begin execution with role'
complete -c bootware -n '__fish_seen_subcommand_from bootstrap' -x -s t -l tags -d 'Ansible playbook tags to select' -a 'desktop server sysadmin wsl $(bootware roles)'
...
complete -c bootware -n '__fish_seen_subcommand_from bootstrap' -x -l user -d 'Remote user login name' -a '$(__fish_complete_users)'
